                        ...
                        <div className="rounded-xl bg-white shadow-xl">
                            <div className="p-6 sm:p-16">
                                ...
                                <div className="mt-16 grid space-y-4">
                                    ...
                                    <input className="flex items-center group h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300 
 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100" type="text" />
